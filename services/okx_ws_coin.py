            ...
            while True:
                ...
                if "data" in data:
                    for entry in data["data"]:
                        ...
                        services.data_store.update_market_data("okx", "btc", "coin", "open_interest", round(oi_ccy, 2), formatted_time)
                ...
                if "data" in data:
                    for entry in data["data"]:
                        try:
                            ...
                            services.data_store.update_market_data("okx", "btc", "coin", "mark_price",
            ...
            while True:
                ...
                if "data" in data:
                    for entry in data["data"]:
                        ...
                        services.data_store.update_market_data("okx", "btc", "coin", "funding_rate",
