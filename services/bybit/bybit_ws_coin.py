...
async def subscribe_bybit_funding_rate(symbol="BTCUSD"):
                ...
                while True:
                    try:
                        ...
                        if "fundingRate" in ticker_data and ticker_data["fundingRate"] is not None:
                            ...
                            services.data_store.update_market_data("bybit", "btc", "coin", "funding_rate", f"{funding_rate:.6f}%", formatted_time)
                        ...
                        if "markPrice" in ticker_data and ticker_data["markPrice"] is not None:
                            ...
                            services.data_store.update_market_data("bybit", "btc", "coin", "mark_price", mark_price, formatted_time)
